/**
 * The ItemList function creates a list of items with their names, quantities, and categories using the
 * Item component.
 * @returns The `ItemList` component is being returned. It contains multiple instances of the `Item`
 * component with different item details such as name, quantity, and category. Each `Item` component
 * represents a specific grocery item from the list.
 */
