...
const NewItem = () => {
    ...
    const handleSubmit = (event) => {
        ...
        console.log(item); // Log item object to console
        alert(`Name: ${name}, Quantity: ${quantity}, Category: ${category}`); // Display alert
    ...
    return (
        <form onSubmit={handleSubmit} className="p-4 bg-slate-700 rounded shadow-md max-w-md mx-auto">
            {/* Name Field */}
            <div className="mb-4">
            ...
            {/* Submit Button */}
            <button type="submit" className="w-full p-2 text-white bg-blue-500 rounded hover:bg-blue-600 my-4">
                Submit
            </button>
        </form>
    );
